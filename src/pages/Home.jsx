...
function Home() {
  ...
  return (
    <div>
      ...
      <section className="py-8 max-container lg:py-10">
        <h2 className="py-8 text-center text-h2">Trending Products</h2>
        <ProductsList type="trending" />
      </section>

      <section className="py-10 rounded max-container">
        <h2 className="py-8 text-center text-h2">Shop Our Top Categories </h2>
        <CategorySection />
      </section>

      <section className="py-16 max-container">
        <h2 className="py-8 text-center text-h2">Most Bought Products</h2>
